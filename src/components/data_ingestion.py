...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        ...
        Description : This method splits the dataframe into trian set and test set based on split ration
        Output : Folder is created in s3 bucket
        On Fialure : Write an exception log and then raise an exception
